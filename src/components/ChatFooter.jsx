...
const ChatFooter = (props) => {
  ...
  function onsubmit()
  {
    ...
    props.onSendMsg(sendText)
    setSendtext({msg:"",time:""})
    
  }
  function fun(){
  if(sendBtEnabled===false || sendText.msg=="")
     return(<MicIcon/>)
